 ...
 * @method Doctrine_Collection getProfessor()               Returns the current record's "Professor" collection
 ...
 * @method AreaAfinidade       setProfessor()               Sets the current record's "Professor" collection
