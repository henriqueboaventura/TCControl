...
/**
 * PropostaAvaliacao form base class.
 *
 * @method PropostaAvaliacao getObject() Returns the current form's model object
 *
 * @package    TCCtrl
 * @subpackage form
 ...
 */
abstract class BasePropostaAvaliacaoForm extends BaseFormDoctrine
{
