...
/**
 * ArtigoVersionamento form base class.
 *
 * @method ArtigoVersionamento getObject() Returns the current form's model object
 *
 * @package    TCCtrl
 * @subpackage form
 ...
 */
abstract class BaseArtigoVersionamentoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('artigo_versionamento[%s]');
